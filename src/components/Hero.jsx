  ...
  return (
    <div className="mt-24 max-w-[1200px] mx-auto relative">
            ...
            >
                ...
                >
                    ...
                    <div className="flex gap-6 flex-row text-4xl md:text-6xl text-purple-600 z-20">
                        ...
                        <motion.a
                        whileHover={{ scale: 1.2 }} className="cursor-pointer"
        ...
        <motion.div
            ...
            className="flex flex-row flex-wrap text-7xl px-12 md:px-0 w-full justify-center items-center gap-2 py-24"
        >
            <p className="text-gray-200 mr-4 text-3xl md:text-4xl font-light">Meu Conjunto de Soluções</p>
            <DiPython className="text-yellow-500 mx-2" />
            <FaAws className="text-orange-500 mx-2" />
            <SiAwslambda className="text-orange-400 mx-2" />
