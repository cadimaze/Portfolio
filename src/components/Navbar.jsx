...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 left-0 w-full bg-opacity-70 backdrop-blur-md z-50'>
        ...
        text-xl items-center px-12 h-20 hidden md:flex gap-12 z-10 cursor-pointer'>

            <li><Link to="hero" smooth={true} offset={50} duration={500}>G. Cadima</Link></li>


            <ul className='hidden md:flex gap-12 z-10 cursor-pointer'>
                <li><Link to="skills" smooth={true} offset={50} duration={500}>Habilidades</Link></li>
                <li><Link to="portfolio" smooth={true} offset={50} duration={500}>Portfólio</Link></li>
