    ...
    <footer className='border-t border-stone-800 mt-8'>
      <div className='max-w-[1200px] mx-auto flex flex-col md:flex-row justify-between items-center gap-6 px-8 py-10'>
        <div className='flex flex-col items-center md:items-start gap-3'>
          ...
          <p className='text-stone-600 text-xs font-mono'>{'//'} desenvolvedor de software &amp; engenheiro de dados</p>
        ...
        <p className='text-stone-700 text-xs font-mono'>© 2026 guilherme cadima — feito com react &amp; tailwind</p>
      </div>
    </footer>
  )
}
